    ...
    private void FixedUpdate()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, CarController.KPH / 180);
                ...
                // get values for fading the sounds based on the acceleration
                    ...
                    accFade = Mathf.Abs((CarController.Throttle > 0) ?CarController.Throttle : 0);

                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f,  CarController.KPH / 10000);
